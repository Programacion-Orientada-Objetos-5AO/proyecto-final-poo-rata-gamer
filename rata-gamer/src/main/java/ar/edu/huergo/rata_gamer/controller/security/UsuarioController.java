package ar.edu.huergo.rata_gamer.controller.security;
...
import ar.edu.huergo.rata_gamer.mapper.security.UsuarioMapper;
...
public class UsuarioController {
    ...
    public ResponseEntity<UsuarioDTO> registrarCliente(@Valid @RequestBody RegistrarDTO registrarDTO) {
        ...
        Usuario nuevoUsuario = usuarioService.registrar(usuario, registrarDTO.getPassword(), registrarDTO.getVerificacionPassword());
